            ...
            <div>
                ...
                <div className="floater">
                    ...
                    <div >
                        ...
                        <p style={{ "display": "inline-block", "fontWeight": "100", "fontSize": "1.5em", "marginLeft": "0.3vw" }}> Fostering since: {this.state.userProfile.yelping_since !== null ? (new Date(this.state.userProfile.yelping_since)).toDateString() : new Date().toDateString()}</p>
